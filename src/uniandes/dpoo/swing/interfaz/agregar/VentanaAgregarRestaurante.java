...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public VentanaAgregarRestaurante( VentanaPrincipal principal )
    {
        ...
        panelBotones = new PanelBotonesAgregar( this ); //Aqui el this significa que se le esta pasandu esta misma ventana (VentanaAgregarRestaurante) al panel de botones, para que pueda llamar metodos como agregarRestaurante() o cerrarVentana().
